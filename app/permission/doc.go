...
should import "github.com/mlekudev/gio/app/permission/bluetooth" as follows:

	package main

	import (
		"github.com/mlekudev/gio/app"
		_ "github.com/mlekudev/gio/app/permission/bluetooth"
	)
