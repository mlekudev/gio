...
of a user interface and is exposed by [github.com/mlekudev/gio/app.FrameEvent]
received from windows.

The [Router] is used by [github.com/mlekudev/gio/app.Window] to track window state and route
